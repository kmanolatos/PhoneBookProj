...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        var createClickHandler = function (row) {
            return function () {
                document.getElementById("kindDescr").value = "";
        ...
        function getList() {
            ...
            if (text.length == 0)
                text = null;
            $.ajax({
                url: hostname + "/api/telephoneKind/getListByWhere/" + text,
                headers: {
                ...
                success: function (result) {
                    ...
                    result.forEach(function (item) {
                        ...
                        var createClickHandler = function (row) {
                            return function () {
                                $.ajax({
                                    url: hostname + "/api/telephoneKind/get/id/" + row.id,
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                                    type: 'GET',
                                    ...
                                    success: function (result) {
                                        ...
                                        document.getElementById("kindDescr").value = result.Kind_Descr;
                                    },
                                    error: function (ex) {
                                        alert(ex.statusText);
                                    }
        ...
        function onUpdate() {
            model.Kind_Descr = document.getElementById("kindDescr").value;
            $.ajax({
                url: hostname + "/api/telephoneKind/update",
                headers: {
        ...
        function onDelete() {
            $.ajax({
                url: hostname + "/api/telephoneKind/delete",
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
                },
                type: 'POST',
        ...
        function onInsert() {
            ...
            model.Kind_Descr = document.getElementById("kindDescr").value;
            $.ajax({
                url: hostname + "/api/telephoneKind/insert",
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
                },
                type: 'POST',
